...
<?php if($direction != 'ltr'): ?>
<link href="catalog/view/theme/radiance/stylesheet/stylesheet-rtl.css" rel="stylesheet">
<?php endif; ?>
...
<script type="text/javascript">
  var lang_dir = '<?php echo $direction; ?>';
</script>
</head>
...
<nav id="top-mobile">
	<?php if (count($languages) > 1) {?>
   	<div class="language">
        <select id="languageSwitch" onchange="location = this.value" class="visible-xs">
        ...
        <a href="javascript:void(0)" class="visible-xs toggleLanguageSwitch top-link">
          <?php foreach ($languages as $language) { ?>
          <?php if ($language['code'] == $code_lang) { ?>
	...
	<div class="currency">
        <select id="currencySwitch" onchange="location = this.value" class="visible-xs">
        ...
        <a href="javascript:void(0)" class="visible-xs toggleCurrencySwitch top-link">
          <?php foreach ($currencies as $currency) { ?>
  ...
  <nav id="menu-mobile">
    <div class="container">
      <div class="navbar-header">
        <span id="category"><?php echo $text_category_mobile; ?></span>
        <button type="button" class="btn btn-navbar navbar-toggle" data-toggle="collapse" data-target=".navbar-ex1-collapse"><i class="fa fa-bars"></i></button>
      </div>
    </div>
     <div class="collapse navbar-collapse navbar-ex1-collapse">
     	<div class="container">
          <ul class="nav navbar-nav main-menu">
            ...
            <?php } ?>
            <?php } ?>
            <li><a href="index.php?route=account/login" class="account-menu"><?php echo $text_account_radiance; ?></a></li>
          </ul>
        </div>
	</div>
  </nav>
